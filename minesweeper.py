...
class MinesweeperApp:
    ...
    def make_cell(self, i, j):
        ...
        # but, we'll just define the functions using def.)
    ...
    def update_time_counter(self):
        ...
        self.time_counter_str.set(time.time() - self.t_0)
    ...
    def right_click_handler(self, i, j):
        ...
        elif not self.game.revealed(i, j) and self.game.flagged(i, j): 
